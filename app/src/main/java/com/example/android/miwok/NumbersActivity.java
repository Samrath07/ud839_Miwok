...
public class NumbersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("keneaku","seven",R.drawable.number_seven,R.raw.number_seven));
        words.add(new Word("kewanto","eight",R.drawable.number_eight,R.raw.number_eight));
